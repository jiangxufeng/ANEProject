...
urlpatterns = [
    ...
    url(r'^shop/comment/(?P<user_id>\d+)/(?P<shop_id>\d+)/$', FoodCommentPublishView.as_view(), name='shop_comment_pub'),
    url(r'^shop/comment/(?P<pk>\d+)$', FoodCommentDetailView.as_view(), name='foodComment_detail'),
